...
function future_imperfect_setup() {
	 ...
	 * to change 'ostraining-future' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'ostraining-future', get_template_directory() . '/languages' );

	/*
	 * Custom functions for the ostraining-future theme
	 */
	...
	add_image_size( 'ostraining-future-large', 840, 341, true );
	add_image_size( 'ostraining-future-small', 351, 176, true );
	add_image_size( 'ostraining-future-logo', 350, 170 );

	// add theme support for the custom logo size
	add_theme_support( 'custom-logo', array(
		'size' => 'ostraining-future-logo',
	) );
	...
	*/
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'ostraining-future' ),
	) );
...
function future_imperfect_widgets_init() {
	register_sidebar( array(
		'name'			=> esc_html__( 'Left Sidebar', 'ostraining-future' ),
		'id'			=> 'sidebar-1',
		'description'	=> '',
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Right Sidebar', 'ostraining-future' ),
		'id'			=> 'right-sidebar',
		'description'	=> '',
...
function future_imperfect_scripts() {
	...
	wp_enqueue_style( 'ostraining-future-font-awesome', get_template_directory_uri() . '/assets/css/font-awesome.min.css' );

	// load the google font
	wp_enqueue_style( 'ostraining-future-google-font', 'http://fonts.googleapis.com/css?family=Source+Sans+Pro:400,700|Raleway:400,800,900' );

	// Loads our main stylesheet.
	wp_enqueue_style( 'ostraining-future-style', get_stylesheet_uri() );

	// load admin css for logged in users
	if ( is_user_logged_in() ) {
		wp_enqueue_style( 'ostraining-future-admin', get_template_directory_uri() . '/assets/css/admin.css', array( 'ostraining-future-style' ), '20121010' );
	}

	// Loads HTML5 shiv
	wp_enqueue_script( 'ostraining-future-html5-shiv', get_template_directory_uri() . '/assets/js/ie/html5shiv.js' );
	wp_script_add_data( 'ostraining-future-html5-shiv', 'conditional', 'lt IE 8' );

	// Loads the Internet Explorer specific stylesheet.
	wp_enqueue_style( 'ostraining-future-ie8', get_template_directory_uri() . '/assets/css/ie8.css', array( 'ostraining-future-style' ), '20121010' );
	$wp_styles->add_data( 'ostraining-future-ie8', 'conditional', 'lt IE 8' );

	wp_enqueue_style( 'ostraining-future-ie9', get_template_directory_uri() . '/assets/css/ie9.css', array( 'ostraining-future-style' ), '20121010' );
	$wp_styles->add_data( 'ostraining-future-ie9', 'conditional', 'lt IE 9' );
	...
	// Add Future Imperfect Footer scripts
	wp_enqueue_script( 'ostraining-future-skel', get_template_directory_uri() . '/assets/js/skel.min.js', array( 'jquery' ), '', true );
	wp_enqueue_script( 'ostraining-future-util', get_template_directory_uri() . '/assets/js/util.js', array( 'ostraining-future-skel' ), '', true );
	wp_enqueue_script( 'ostraining-future-ie-respond', get_template_directory_uri() . '/assets/js/ie/respond.min.js', '', '', true );
	wp_script_add_data( 'ostraining-future-ie-respond', 'conditional', 'lt IE 8' );
	wp_enqueue_script( 'ostraining-future-main', get_template_directory_uri() . '/assets/js/main.js', array( 'ostraining-future-util' ), '', true );
